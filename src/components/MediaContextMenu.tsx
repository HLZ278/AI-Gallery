...
export type MediaContextAction = 'copy' | 'copyPath' | 'lanShare' | 'removeFromDb' | 'deleteFromDisk' | 'showInFolder'

function buildMenuItems(_mediaType: MediaType, variant: 'full' | 'preview'): ContextMenuItem[] {
  if (variant === 'preview') {
    return [
      { id: 'copy', label: '复制文件' },
  ...
  return [
    ...
    { id: 'showInFolder', label: '打开文件所在位置' },
    { id: 'removeFromDb', label: '从数据库移除' },
    { id: 'deleteFromDisk', label: '从本地删除', danger: true }
  ]
}
